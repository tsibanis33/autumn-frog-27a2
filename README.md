...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/autumn-frog-27a2)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/autumn-frog-27a2
```

A live public deployment of this template is available at [https://autumn-frog-27a2.templates.workers.dev](https://autumn-frog-27a2.templates.workers.dev)
